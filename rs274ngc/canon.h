...
/* Used for threading (g33, g76). */
extern void START_SPEED_FEED_SYNCH(int lineno, double feed_per_revolution, bool velocity_mode);
extern void STOP_SPEED_FEED_SYNCH(int lineno);
